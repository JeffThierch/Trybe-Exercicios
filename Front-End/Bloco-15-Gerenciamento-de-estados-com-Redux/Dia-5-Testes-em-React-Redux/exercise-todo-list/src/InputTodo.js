    ...
    return (
      <div className="InputTodo">
        ...
        <label htmlFor="filter-select">
          ...
          >
            <option data-testid="filter-option" value="all">Todos</option>
            <option data-testid="filter-option" value="completed">Concluidos</option>
            <option data-testid="filter-option" value="uncompleted">Incompletos</option>
          </select>
